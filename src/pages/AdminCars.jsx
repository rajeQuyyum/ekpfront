...
export default function AdminCars() {
  ...
  return (
    <div className="p-6 bg-white rounded shadow w-full">
      <h2 className="font-bold text-xl mb-4">Cars Management</h2>

      {/* CREATE */}
      <div className="border p-4 rounded mb-6">
        <h3 className="font-semibold mb-3">Create New Car</h3>

        <input
          className="border p-2 w-full mb-2 rounded"
          placeholder="Car Name (max 30 characters)"
          maxLength={30}
          value={name}
        ...
        <div key={item._id} className="border p-3 rounded mb-3 bg-gray-50">
          {editingId === item._id ? (
            <>
              ...
              <input
                className="border p-2 w-full mb-2 rounded"
                 placeholder="Phone Number (max 25 characters)"
                maxLength={25}
                value={editLocation}
